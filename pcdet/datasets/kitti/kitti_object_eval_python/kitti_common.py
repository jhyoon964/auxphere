...
def get_image_gt_path(idx, prefix, training=True, relative_path=True):
    return get_kitti_info_path(idx, prefix, 'image_gt', '.png', training,
                               relative_path)
...
def get_kitti_image_info(path,
    ...
    def map_func(idx):
        ...
        image_info['img_path'] = get_image_path(idx, path, training,
                                                relative_path)
        image_info['img_path_gt'] = get_image_gt_path(idx, path, training,
                                        relative_path)
        if with_imageshape:

...
class PointSample(nn.Module):
    ...
    def forward(self, batch_dict):
        ...
        for index in range(batch_size):
            ...
            # print('cur_points_2d_shape : ',cur_points_2d.shape) # 16384 2
            ...
            # print('cur_point_feats : ',cur_point_feats.shape)   # 16384 32
            # print('image.shape : ',img_shape)                   # 448 1472
            # print('cur_img_feats : ',cur_img_feats.shape)       # 1 32 112 368
